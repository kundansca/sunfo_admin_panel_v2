...
const EditProducForm = (props:any) => {
   console.log(props)
   ...
   const navigate=useNavigate();
          ...
          let fetchData=props.productData;
    ...
    const [productData,setProductData]=useState<any>({title:"",brand:"",tags:[],description:"",productCode:"",isInStock:false,sellingPrice:null,discount:null,
        disableProduct:false,color:"",colorsAvailable:[],sizesAvailable:[],categories:[],...fetchData});
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="panel lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
                <h5 className="font-semibold text-lg dark:text-white-light">Edit Product Form</h5>
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            className="w-full"
                            // defaultValue={[{value:productData.category._id,label:productData.category.name}]}
                            // value={[{value:productData.category._id,label:productData.category.name}]}
