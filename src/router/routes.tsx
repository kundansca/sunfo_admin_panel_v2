...
const NewAllBanners= lazy(() => import('../pages/NewAllBanners'));
const AddNewBanner= lazy(() => import('../pages/AddNewBanner'));
const EditBanner= lazy(() => import('../pages/EditBanner'));
const AddProduct = lazy(() => import('../pages/AddProduct'));
const EditProdcut = lazy(() => import('../pages/EditProduct'));
...
const ManageSubscribeUsers= lazy(() => import('../pages/ManageSubscribeUsers'));
...
//@ts-ignore
const Protected = lazy(() => import('../components/Protected.jsx'));
//@ts-ignore
...
const routes = [
    ...
    // // },
    // {
    //     path:"/new-all-banners",
    //     element:<NewAllBanners/>
    // },
    // {
    //     path:"/add-new-banner",
    ...
    // },
    // {
    //     path: '/manage-subscribe-users',
        
    //     element: <ManageSubscribeUsers />,
